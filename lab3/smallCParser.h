...
public:
  ...
  public:
    std::vector<smallc::ArrayDeclNode*> arrs;
  ...
  public:
    smallc::PrimitiveTypeNode * varTypeNode;
  ...
  public:
    smallc::PrimitiveTypeNode * retTypeNode;
    smallCParser::VarTypeContext *varTypeContext = nullptr;;
  ...
  public:
    smallc::ConstantExprNode * constantNode;
  ...
  public:
    smallc::BoolConstantNode * boolConstNode;
  ...
  public:
    smallc::StmtNode* stmtNode;
    smallc::ExprStmtNode * tempExprStmtNode;
  ...
  public:
    smallc::ExprNode* exprNode;
    smallc::CallExprNode * tempCallExprNode;
    smallc::UnaryExprNode * tempUnaryExprNode;
    smallc::BinaryExprNode * tempBinaryExprNode;
    smallc::BoolExprNode * tempBoolExprNode;
  ...
  public:
    smallc::ReferenceExprNode* varNode;
    smallCParser::VarNameContext *varNameContext = nullptr;;
    smallCParser::ArrNameContext *arrNameContext = nullptr;;
    smallCParser::IntExprContext *intExprContext = nullptr;;
  ...
  public:
    std::vector<smallc::ParameterNode*> pars;
  ...
  public:
    ...
    smallc::ArrayTypeNode * tempArrayTypeNode;
    smallCParser::VarTypeContext *varTypeContext = nullptr;;
    smallCParser::VarNameContext *varNameContext = nullptr;;
    smallCParser::ArrNameContext *arrNameContext = nullptr;;
  ...
  public:
    smallc::IdentifierNode * varNameNode;
  ...
  public:
    smallc::IdentifierNode * arrNameNode;
    antlr4::Token *idToken = nullptr;;
  ...
  public:
    smallc::IdentifierNode * fcnNameNode;
    antlr4::Token *idToken = nullptr;;
  ...
  public:
    smallc::IntConstantNode * intConstNode;
